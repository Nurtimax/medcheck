...
export const service_accordion = [
   ...
   },
   {
      ...
      text: 'Концентрация перекиси водорода в отбеливающем геле на 10% ниже, чем в системах предыдущего поколения: 25% против 35%. В результате активный компонент воздействует мягче, что делает ZOOM-4 самым безопасным из существующих на сегодня видов кабинетного отбеливания.',
      children: [],
   },
   {
      id: 5,
      title: 'Сколько держится результат?',
      text: 'Периоды актуальности полученных данных по диагностике зависят от типа исследования. Хотя анализ мочи и крови часто рекомендуют сдать в одно время, есть разница в периоде действия.',
      children: [],
   },
]
